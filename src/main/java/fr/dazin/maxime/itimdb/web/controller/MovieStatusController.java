...
public class MovieStatusController {
    ...
    public List<MovieWithStatusDto> listFavorites(@Parameter(example = "1") @PathVariable long userId, @Parameter(
            example = "releaseDate",
            description = "Champ utilisé pour trier les films",
            schema = @Schema(allowableValues = {"releaseDate", "rating"})
    ) @RequestParam(defaultValue = "releaseDate") String sortBy,@Parameter(example = "asc",
